...
const SuccessFullStudents = () => {
    ...
    <div className="my-12 max-w-6xl mx-auto ">
      ...
      <div className="grid sm:grid-cols-3 md:grid-cols-6 lg:grid-cols-12 grid-flow-dense gap-1">
        <img
          src="https://media.istockphoto.com/id/1028934888/photo/thumb-up.jpg?s=612x612&w=is&k=20&c=LogDROwBVX6LrdikaDgs-gJp_m6PTpH41h3Nj6wS6Gg="
          alt=""
        />
        <img
        ...
        <img
          className="col-span-2 row-span-4"
          src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1887&q=80"
          alt=""
        />
        <img
          src="https://images.unsplash.com/photo-1525134479668-1bee5c7c6845?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"
          alt=""
        />

        <img
          src="https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mjd8fHBlb3BsZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=600&q=60"
          alt=""
        />
        <img
        ...
        />
        <img
          src="https://images.unsplash.com/photo-1530268729831-4b0b9e170218?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
          alt=""
        />
        <img
          className="col-span-2"
          src="https://images.unsplash.com/photo-1463453091185-61582044d556?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
          alt=""
        />
        <img
